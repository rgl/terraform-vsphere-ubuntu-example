# Usage (Ubuntu 26.04 host)

Install the [Ubuntu 26.04 VM template](https://github.com/rgl/ubuntu-vagrant).
...
wget https://github.com/vmware/govmomi/releases/download/v0.55.0/govc_Linux_x86_64.tar.gz
...
```bash
choco install -y --version 1.15.7 terraform
choco install -y --version 0.55.0 govc
```
...
export TF_VAR_vsphere_ubuntu_template='vagrant-templates/ubuntu-26.04-amd64-vsphere'
